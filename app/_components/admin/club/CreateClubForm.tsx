...
const RichTextEditor = dynamic(() => import("@/components/BlogEditor"), {
  ssr: false,
  loading: () => (
    <div className="h-40 w-full bg-gray-100 dark:bg-gray-800 animate-pulse rounded-lg" />
  ),
});
...
const inputCls =
  "w-full px-3 py-2 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 outline-none text-sm";
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <section className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 space-y-4">
          ...
          <div>
            <label className="text-xs text-gray-500 mb-1 block">
              Short Description{" "}
              <span className="text-gray-400">(shown in listings)</span>
            </label>
            <textarea
          ...
          <div>
            <label className="text-xs text-gray-500 mb-1 block">
              Full Description *{" "}
              <span className="text-gray-400">(rich text)</span>
            </label>
            <Controller
              ...
              render={({ field }) => (
                <RichTextEditor
                  ...
                  placeholder="Detailed club description..."
                  minHeight="200px"
                />
              )}
            />
        ...
        <section className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 space-y-4">
          ...
          <div
            ...
            className="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl p-8 text-center cursor-pointer hover:border-blue-400 transition-all"
          >
        ...
        <section className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 space-y-4">
          ...
          {locationsField.fields.map((_, i) => (
            <div
              key={i}
              className="border border-gray-200 dark:border-gray-700 p-4 rounded-lg space-y-3"
            >
